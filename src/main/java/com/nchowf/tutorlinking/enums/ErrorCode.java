...
public enum ErrorCode {
    ...
    ALREADY_REGISTERED(1026,"Bạn đã đăng ký nhận này rồi" , HttpStatus.BAD_REQUEST),
    REGISTRATION_NOT_FOUND(1027,"Đăng ký nhận lớp không tồn tại" ,HttpStatus.NOT_FOUND ),
    NOT_YOUR_REGISTRATION(1028,"Bạn không thể xóa đăng ký của gia sư khác" , HttpStatus.FORBIDDEN);
